...
from spins2.ising import bilayer_ab_u_3_update
...
def run(file, init, X, Y, J, arrays_temperatures, nequilibrium, nworks):
    ...
    logging.info("{} {:<8} {} {:<8} {:<8} {:<8} {}".format("init:", init, "parameters(meV):", J0, J1, Ja, "S=3/2"))
    if init == "fm":
        ...
        for i in range(lav):
            t, Nw, Ew = bilayer_ab_u_3_update.iteration3(latt, X_s, Y_s, J0, J1, Ja, arrays_values[i], nequilibrium, nworks)
        ...
        logging.info("{:>16} {:>16} {:>16} {:>16} {:>16} {:>16} {:>16}".format(
            "Temperature", "magnetism0", "magnetism1", "susceptibility0", "susceptibility1", "specific heat", "time(s)"))
        for i in range(lav):
            t, Nw, Ew = bilayer_ab_u_3_update.iteration3(latt, X_s, Y_s, J0, J1, Ja, Jb, J1_, arrays_values[i], nequilibrium, nworks)
